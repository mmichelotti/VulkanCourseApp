...
bool Instance::CheckExtensionSupport(std::vector<const char*>* checkExtensions)
{
    std::unordered_set<std::string> availableExtensions = GetExtensions();
...
std::unordered_set<std::string> Instance::GetExtensions()
{
